...
DefinedOrUnknownSVal SValBuilder::conjureSymbolVal(const void *SymbolTag,
  ...
  return conjureSymbolVal(SymbolTag, Ex, LCtx, T, Count, PS);
}
...
DefinedOrUnknownSVal SValBuilder::conjureSymbolVal(const void *symbolTag,
  ...
  SymbolRef sym = SymMgr.conjureSymbol(expr, LCtx, type, count, symbolTag, PS);
...
DefinedOrUnknownSVal SValBuilder::conjureSymbolVal(const Stmt *stmt,
  ...
  SymbolRef sym = SymMgr.conjureSymbol(stmt, LCtx, type, visitCount, nullptr, ps);
...
SValBuilder::getConjuredHeapSymbolVal(const Expr *E,
  ...
  SymbolRef sym = SymMgr.conjureSymbol(E, LCtx, T, VisitCount, nullptr, ps);
