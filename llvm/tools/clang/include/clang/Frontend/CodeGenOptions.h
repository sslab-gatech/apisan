...
public:
  ...
  /// Name of the configuration file to use with -ffs-semantic
  std::string FsSemanticConfFile;

  /// Name of the output directory to use with -ffs-semantic-out-dir
  std::string FsSemanticOutDir;
