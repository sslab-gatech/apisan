...
public:
  AnalyzerOptions() :
    ...
    AnalysisPurgeOpt(PurgeNone), // FSS: never purge constraints
    DisableAllChecks(0),
    ShowCheckerHelp(0),
    AnalyzeAll(0),
    ...
    InliningMode(NoRedundancy), // FSS: NoRedundancy: do not generate results of inlined functions
                                // FSS: All: generate results of inlined functions
    UserMode(UMK_NotSet),
    IPAMode(IPAK_NotSet),
